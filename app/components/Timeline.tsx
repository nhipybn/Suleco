    ...
    <div className="w-80% overflow-hidden bg-white py-10">
      <div className="flex animate-scroll-timeline space-x-4">
        {[...events, ...events].map((event, idx) => (
          <div
            key={idx}
            className="border-2 border-red-200 flex flex-col items-center bg-white rounded-xl shadow-md p-2 min-w-[250px] h-[260px] md:h-[170px] hover:scale-105 transition-transform duration-300"
          >
